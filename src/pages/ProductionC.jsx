  ...
  return (
    <div>
      ...
      <div className="bg-white py-4 text-center">  
        <h1 className="px-4 text-black text-3xl lg:text-5xl text-center fold-primary font-black">From Fundamentals to <span className='text-primary-600'>First Responder</span></h1>
          <p className='font-primary font-medium text-xl text-gray-800 mt-4 '>Production Support Engineering (HARD)</p>
      </div>
