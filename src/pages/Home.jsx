...
const Home = () => {
  ...
  const javaicon = (
    <svg className="w-full w-35 h-35" fill="url(#textGradient)" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <defs>
  ...
  const pythonIcon = (
    <svg className="w-full w-35 h-35 pt-2" viewBox="-2.85 -2.85 20.70 20.70" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" strokeWidth="0.00015000000000000001">
       <defs>
    <linearGradient id="textGradient" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stopColor="#0b090a" />
      <stop offset="100%" stopColor="#ba181b" />
    </linearGradient>
  </defs><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3 12H1.5C0.671573 12 0 11.3284 0 10.5V5.5C0 4.67157 0.671573 4 1.5 4H8V3H7V2H6V3H4V1.5C4 0.671573 4.67157 0 5.5 0H9.5C10.3284 0 11 0.671573 11 1.5V6.5C11 6.77614 10.7761 7 10.5 7H4.5C3.67157 7 3 7.67157 3 8.5V12Z" fill="url(#textGradient)"></path> <path d="M12 3V6.5C12 7.32843 11.3284 8 10.5 8H4.5C4.22386 8 4 8.22386 4 8.5V13.5C4 14.3284 4.67157 15 5.5 15H9.5C10.3284 15 11 14.3284 11 13.5V12H9V13H8V12H7V11H13.5C14.3284 11 15 10.3284 15 9.5V4.5C15 3.67157 14.3284 3 13.5 3H12Z" fill="url(#textGradient)"></path> </g></svg>
    

  );
  const dotnetIcon = (
    <svg className="w-full w-35 h-35" fill="url(#textGradient)" viewBox="0 0 14 14" role="img" focusable="false"
    ...
    <linearGradient id="textGradient" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <stop offset="100%" stopColor="#ba181b" />
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <defs>
                    <clipPath id="clip0">
                      <rect width="169" height="99" fill="white" transform="translate(0.777344)"></rect>
                    </clipPath>
                  </defs>r
                </g>
              </svg>
  ...
  const productionIcon = (
    <svg className="w-full w-35 h-35" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" strokeWidth="3"
                stroke="url(#textGradient)" fill="none">
                  <defs>
    <linearGradient id="textGradient" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stopColor="#0b090a" />
      <stop offset="100%" stopColor="#ba181b" />
                ...
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                  <path d="M12.91,31.8V26.1a19.09,19.09,0,0,1,38.18,0v5.7" strokeLinecap="round"></path>
                  <path
                  ...
                  <path
                    ...
                    transform="translate(102.18 76.98) rotate(180)" strokeLinecap="round"></path>
                  <path d="M51.7,45.56v5a4,4,0,0,1-4,4H36.56" strokeLinecap="round"></path>
                  <rect x="28.45" y="51.92" width="8.1" height="5.07" rx="2" strokeLinecap="round"></rect>
                </g>
              </svg>
  );
  const devIcon= (
    <svg className="w-full w-35 h-35" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="url(#textGradient)">
      <defs>
    <linearGradient id="textGradient" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stopColor="#0b090a" />
      <stop offset="100%" stopColor="#ba181b" />
  ...
  return (
    ...
    <section className="h-[calc(100vh-128px)] bg-white text-black flex flex-col justify-center items-center my-auto">
        ...
        <p className="text-center font-primary  text-lg mb-4 block xl:hidden">Empowering Careers <span className="text-red-600 font-medium">Since 2007</span></p>
        ...
        <div className="hidden xl:flex justify-center items-center ">
          <div className="relative  group inline-block px-4 py-2 overflow-hidden text-black [border-radius:var(--radius)]"  style={myStyle}>
        ...
        <h1 className="text-3xl sm:text-3xl  lg:text-4xl xl:text-5xl font-primary font-bold blur-animate text-center">"Dreaming of
          Becoming a <span className="text-red-600">Software Engineer?</span></h1>
        <h1 className="text-2xl sm:text-3xl  lg:text-4xl xl:text-5xl font-primary font-bold text-center mt-2 blur-animate">Let’s Make
          It Happen!"</h1>
        ...
        <div className="flex text-center justify-center mt-8 ">
            ...
            <button className=" group relative cursor-pointer overflow-hidden whitespace-nowrap px-6 py-4 text-white [background:var(--bg)] [border-radius:var(--radius)]  transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_8px_rgba(62,61,117,0.7)] flex justify-center " style={myStyle2} >
              ...
              <div className="absolute [background:var(--bg)] [border-radius:var(--radius)] [inset:var(--cut)]"></div>
              <span className="z-10 w-48 whitespace-pre bg-gradient-to-b from-black from-30% to-gray-300/80 bg-clip-text text-center font-secondary text-base font-semibold leading-none tracking-tight text-white"><Link to={'aboutus'}>Talk to Us Today</Link></span>
          </button>
          ...
          <div className="lg:hidden flex justify-center lg:hidden mt-6 border-gray-800">
            ...
            <ul className="flex space-x-5 text-black font-secondary">
              <li><a href="https://www.facebook.com/share/1H6HomtGnP/" target="_blank" className="hover:text-red-600  transform">
                  <svg className="w-8 h-8 fill-black hover:fill-blue-600 transition duration-300 ease-in-out"
              ...
              <li><a href="https://www.instagram.com/uniqtechs?igsh=MXM2dDRnYW16cncyNQ==" target="_blank">
                  <svg viewBox="0 0 48 48"
                    ...
                    xmlns="http://www.w3.org/2000/svg" stroke="#DFDFD6" strokeWidth="0.00048000000000000007">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#000000"
                      strokeWidth="6.144">
              ...
              <li><a href="https://youtube.com/@uniqtechnologiesofficial?si=TjCFfum3corJj1K_" target="_blank">
                  <svg className="w-8 h-8 fill-black hover:fill-red-600 transition duration-300 ease-in-out" height="200px"
              ...
              <li><a href="https://twitter.com/Uniqtechs?t=Uq2VphiMgcDiTzDgQRuYQg&s=08" target="_blank">
                <svg className="w-8 h-8 p-2 bg-black rounded-full fill-white hover:bg-sky-600 transition duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 32 32">
              ...
              <li><a href="https://t.me/uniqtechnologies" target="_blank">
                  <svg className="w-8 h-8 fill-black hover:fill-sky-400 transition duration-300 ease-in-out" viewBox="0 0 32 32"
                    xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
      ...
      <div className="my-8 text-center">  
        <h1 className="px-4 text-black text-3xl lg:text-5xl text-center fold-primary font-black">What You’ll <span className="text-red-600">
            Learn with Us</span></h1>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-3 px-2 sm:px-10 lg:px-20 gap-4 bg-white py-10">
        <CourseCard courseRoute={'courses'} courseTitle="Java Fullstack Development" CourseSalary="₹6L - ₹15L PA" courseDescription="Massive job openings in MNCs. Get placed with in-demand skills" icon={javaicon}/>
        <CourseCard courseRoute={'pythonCourse'} courseTitle="Python Fullstack Development" CourseSalary="₹5L – ₹12L PA" courseDescription="Huge demand in startups & AI-driven companies fmdsfds;ls" icon={pythonIcon}/>
        <CourseCard courseRoute={'DotnetCourse'} courseTitle="Dotnet Fullstack Development" CourseSalary="₹6L – ₹14L PA" courseDescription="Strong demand in banking, healthcare, and ERP sectors " icon={dotnetIcon}/>
        <CourseCard courseRoute={'DataEngineerCourse'} courseTitle="Data Engineering" CourseSalary="₹5L – ₹12L PA" courseDescription="Moderate job openings across MNCs and product teams" icon={dataIcon}/>
        <CourseCard courseRoute={'ProductionCourse'} courseTitle="IT Production Support" CourseSalary="₹4L – ₹10L PA" courseDescription="Great for those looking to build stability before switching roles " icon={productionIcon}/>
        <CourseCard courseRoute={'devOps'} courseTitle="DevOps/Amazon Web Services" CourseSalary="₹4L – ₹10L PA" courseDescription="Excellent for candidates with gaps or domain switchers seeking growth" icon={devIcon}/>
      </div>
      <div className="py-4 sm:py-8 text-center bg-gray-200">  
        <h1 className="px-2 text-black text-2xl lg:text-5xl fold-primary font-black">Our Training &<span className="text-red-600"> Placement Approach</span></h1>
    </div>
      <ProcessCard/>
      <div className="bg-black pt-4 text-center">  
        <h1 className="px-4 text-white text-3xl lg:text-5xl text-center fold-primary font-black">How Can <span className="text-red-600">
            We Help You?</span></h1>
      </div>
      <Carosoul/>
      <Pricing/>
      <div className="bg-gray-200 pt-8 text-center">  
        <h1 className="px-20 text-black text-3xl lg:text-5xl text-center fold-primary font-black">Are you a Fresher and  <span className="text-red-600">
            Confused about where to start???</span></h1>
            <p className="mx-auto mt-4 max-w-5xl text-gray-800 text-center font-secondary text-lg">
          Wish to pursue ur Career in IT ???  These 3 must-watch videos will clear your doubts, guide your path, and show you how to land your dream job faster and smarter.
        </p>
      </div>
      <Videogrid/>
      <div className="pt-10 text-center bg-black">  
        <h1 className="px-4 text-white text-3xl lg:text-5xl text-center fold-primary font-black">Key Features of<span className="text-red-600"> Training Program</span></h1>
      </div>
      <FeatureCard/>
      <div className=" py-4 text-center">  
        <h1 className="px-4 text-black text-3xl lg:text-5xl text-center fold-primary font-black">Our Student's <span className="text-red-600">
            Success Stories</span></h1>
            <p className="mx-auto mt-4 max-w-5xl text-gray-900 text-center font-secondary text-lg">
          Confused about where to start? These 3 must-watch videos will clear your doubts, guide your path, and show you
          how
          to land your dream job — faster and smarter.
        </p>
      </div>
      <FresherGrid/>
