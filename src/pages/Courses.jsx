...
import BannerLeft from '../components/Courses/BannerLeft.jsx'
  ...
  questions: [
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          description: "Differences Between Abstract Classes and Interfaces",
          answers: []
        }
      ]
    }
      ...
      descriptions: [
        {
          description: "Inversion of Control (IoC)",
          answers: [
            "Understanding Dependency Injection (DI) concepts"
          ]
        },
        {
          description: "Bean lifecycle and scopes",
          answers: [
            "Singleton, Prototype, and other bean scopes"
          ]
        }
      ]
    },
      ...
      descriptions: [
        {
          ...
          answers: [
            "Configuring beans and properties with XML"
          ]
        },
        {
          description: "Annotation-based configuration",
          answers: [
            "Using @Configuration, @Bean, etc."
          ]
        },
        {
...
,{
  module: "Module 17: DevOps and Continuous Integration/Continuous Deployment (CI/CD)",
  questions: [
    {
      ...
      descriptions: [
        {
          ...
          answers: [
            "Evaluating AWS, Azure, Google Cloud"
          ]
        },
        {
        ...
        },
        {
          ...
          answers: [
            "Setting up CI/CD pipelines for cloud deployments"
          ]
        }
      ]
    }
  ...
  return (
    ...
    <div className="bg-white py-4 text-center">  
        <h1 className="px-4  text-black text-3xl lg:text-5xl text-center fold-primary font-black">From Zero to <span className="text-red-600">
          ...
          <p className='font-primary font-medium text-xl text-gray-800 mt-4 '>Java Fullstack Development (HARD)</p>
      </div>
    <div className='relative'>
      <div className="relative overflow-hidden px-20 py-10">
       ...
       {roadmapData.map((item, index) => (
        ...
        <p className="absolute bottom-32 right-35 font-primary font-bold text-xl pt-4 text-center lg:text-end">Total: <span className="text-red-600">120</span> Days to <span className="text-red-600">150</span> Days</p>
    </div>
    <div className="bg-gray-100 py-6 text-center">  
        <h1 className="bg-gradient-to-r from-[#0b090a] to-[#ba181b] bg-clip-text text-transparent text-3xl lg:text-5xl text-center fold-primary font-black">
            Our Java Full Stack Development Syllabus</h1>
          <p className='font-primary font-medium text-xl text-gray-800 mt-4'>(HARD)</p>
      </div>
      <div className="flex items-center justify-end px-20 bg-gray-100" data-aos="fade-up">
        <DownloadSyllabus/>
      </div>
